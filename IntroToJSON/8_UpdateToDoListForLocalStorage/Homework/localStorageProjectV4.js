...
// array to hold all the unique color objects
// captured from the user submitting a form
var theColorsArray = new Array();

// global variable to keep track of how many colors form submittal objects there
...
// this getTheColors() function retrieves all the colors stored in the local storage
// and pushes them to the global [theColors] array
// which is used as the input to addColorsToPage() function
...
//this function processes user input from the form
// as the click event when the user clicks on the 'submit' button 
// the function works by creating one big object containing all five form fields
// and then pushing that object to [theColor] array
function getFormData() {
	...
	for (i=1;i<=5; i++)	{
		...
		var colorId = "color" + (maxColorId +i);
